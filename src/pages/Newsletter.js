  ...
  return (
    <Layout>
        <form onSubmit={onSubmit}  
            ...
            <button disabled={!emailAddress} className='btn'>Subscribe</button>
            <p className='mt-4'>Want to unsubscribe? <span className='text-violet-500 dark:text-violet-300'><NavLink to='/unsubscribe'> Unsubscribe</NavLink></span></p>
        </form>
    </Layout>
  )
}
