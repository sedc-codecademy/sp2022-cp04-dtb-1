...
useEffect(() => {
  ...
  return (
    ...
    <>
     {/* 1rst */}
     <div key={posts[0].id} style={{backgroundImage: `url(${posts[0].imageUrl})`}} className={'relative w-full lg:w-1/2 border-2 bg-cover'}>
        ...
        <div  className='lg:flex lg:w-1/2  lg:flex-col'>     
            ...
            {/* 2nd */}
            <div key={posts[1].id} className={'relative w-full  lg:w-full  border-2'}>
